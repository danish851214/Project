                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">Nagawara,Bengaluru,Karnataka 560045</span> <br>
										<span class="text-white">Gate No-5 Patna,Bihar 851201</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+91-934103321</span>
										<span class="text-white">+91-7620006239 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">danishzahen@gmail.com</span>
										<span class="text-white">dmd850294@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
